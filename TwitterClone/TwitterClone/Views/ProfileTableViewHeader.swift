...
//  TwitterClone
//
//  Created by Elizeu RS on 03/07/23.
//
...
//    sectionStack.backgroundColor = .systemPink
...
//        print(sender.titleLabel?.text ?? "")
  ...
  private func configureConstraints() {
    ...
    let joinedDateLabelViewConstraints = [
    ...
    NSLayoutConstraint.activate(joinedDateLabelViewConstraints)
